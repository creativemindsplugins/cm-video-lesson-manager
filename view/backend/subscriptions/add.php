<form action="<?php echo esc_attr($currentUrl); ?>" method="post" class="cmvl-subscription-add-form">
	...
	<div class="inner <?php echo (isset($_GET['success']) ? 'open' : 'closed'); ?>">
		<label class="cmvl-subscription-add-find-post">Find channel: <input type="text" name="post_find" /></label>
		<label class="cmvl-subscription-add-post">Channel: <span></span>
			<a href="#" class="cmvl-subscription-add-post-remove">(remove)</a>
