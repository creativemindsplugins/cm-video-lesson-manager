...
class FreeController extends Controller {
	...
	static function admin_menu() {
		...
		//add_submenu_page(App::MENU_SLUG, App::getPluginName() . ' User Guide', 'User Guide', 'manage_options', self::getMenuSlug('user-guide'), array(get_called_class(), 'userGuide'));
		//add_submenu_page(App::MENU_SLUG, 'Upgrade to '. App::getPluginName() .' Pro', 'Upgrade to Pro', 'manage_options', self::getMenuSlug('upgrade'), array(get_called_class(), 'upgradeToPro'));
	}
