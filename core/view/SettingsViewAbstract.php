...
abstract class SettingsViewAbstract {
	...
	public function renderCategory($category) {
		...
		return '<div class="settings-category settings-category-'. $category .'">'. apply_filters('cmvl-settings-category', $result, $category) .'</div>';
	}
	...
	public function renderSubcategory($category, $subcategory) {
		...
		return '<div class="settings_'. $category .'_'. $subcategory .'">'. apply_filters('cmvl-settings-subcategory', $result, $category, $subcategory) .'</div>';
	}
	...
	public function renderOptionControls($name, array $option = array()) {
		...
		switch ($option['type']) {
			...
			case Settings::TYPE_CUSTOM:
				if (is_callable($option['content'])) return call_user_func($option['content'], $name, $option);
				else return $option['content'];
			default:
